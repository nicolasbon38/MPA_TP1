...
for (t in seq(1, taille)){
  y <- rnorm(1, theta / 4, sqrt(2))
  theta <- rnorm(1, 2 * y, 4)
  #On ne stocke pas les 100 premières valeurs
  if (t > 50){
    les_y <- c(les_y, y)
    les_thetas <- c(les_thetas, theta)
  }
}

#on trace les points
plot(les_y, les_thetas, col="grey")
...
abline(lm(les_thetas ~ les_y), col="orange")
```
