...
Voici l'implémentation de l'algorithme de Metropolis-Hasting :
...
```
On voit que la moyenne et la medianne sont proches de la valeur obtenue, c'est ce qu'on attendait.
